...
Configurationها، DataSourceها و سایر تنظیمات Runtime عملاً بخشی از فرآیند
استقرار هستند.
...
v2.0.0
```
Orchestra مستقیماً Repository مورد نظر را از طریق Git URL دریافت کرده و Tag
انتخاب‌شده را Checkout می‌کند.
